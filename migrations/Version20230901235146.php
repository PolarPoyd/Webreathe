 ...
 */
final class Version20230901235146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module_data ADD speed VARCHAR(255) NOT NULL, ADD flow VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module_data DROP speed, DROP flow');
    }
}
